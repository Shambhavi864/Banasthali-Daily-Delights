    ...
    <div class="container mt-5 ">
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <hr />
          <img src="images/we.png" class="img-fluid d-block rounded mx-auto image-thumbnail">
          <p class="mt-2">We are B.tech - CSE Students of batch 2021-2025. Shambhavi, Nishtha, Naureen and Nandini</p>
        </div>
        <div class="col-md-5 mt-3">
          <span class="text-warning pt-3">
            <h1 class="title">B2D</h1>
            <h3>Banasthali Daily Delights - The Online Shopping platform</h3>
          </span>
          <hr>
          <p>The purpose of the Banasthali Daily Delights, B2D (online grocery shopping web 
...
commitments.
  ...
  <div class="container mt-3 d-flex justify-content-center card pb-3 col-md-6">
    ...
    <form class="col-md-12" action="https://formspree.io/EnterYourEmail" method="POST" name="_next">
      <h3 class="text-warning pt-3 title mx-auto">Contact - b2d@gmail.com / 8967445561</h3>
    </form>
  </div>
